...
import net.cheto97.rpgcraftmod.entity.client.Models.RPGTameableModel;
...
public abstract class RPGTameableRenderer<T extends RPGEntityTameable> extends GeoEntityRenderer<T> {
    ...
    RPGTameableRenderer(EntityRendererProvider.Context context, RPGTameableModel<T> modelProvider) {
