...
public class GluttonModel extends AnimatedGeoModel<Glutton> {
    @Override
    public ResourceLocation getAnimationResource(Glutton entity) {
        return new ResourceLocation(RpgcraftMod.MOD_ID, "animations/glutton.animation.json");
    }

    @Override
    public ResourceLocation getModelResource(Glutton entity) {
        return new ResourceLocation(RpgcraftMod.MOD_ID, "geo/glutton.geo.json");
    }

   @Override
    public ResourceLocation getTextureResource(Glutton entity) {
        return new ResourceLocation(RpgcraftMod.MOD_ID, "textures/entity/glutton/glutton.png");
    }
