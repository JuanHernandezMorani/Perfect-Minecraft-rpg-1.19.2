...
public class GemInfusingStationRecipeCategory implements IRecipeCategory<GemInfusingStationRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(RpgcraftMod.MOD_ID, "gem_infusing");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(RpgcraftMod.MOD_ID, "textures/gui/gem_infusing_station_gui.png");
    ...
    public RecipeType<GemInfusingStationRecipe> getRecipeType() {
        return JEIRpgcraftModPlugin.INFUSION_TYPE;
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, GemInfusingStationRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT,55,15).addIngredients(ForgeTypes.FLUID_STACK, List.of(recipe.getFluid())).setFluidRenderer(600000,false,16,61);
