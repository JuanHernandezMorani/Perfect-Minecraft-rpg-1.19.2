...
import net.cheto97.rpgcraftmod.menu.slot.EquipmentSlots;
import net.cheto97.rpgcraftmod.menu.slot.OffhandSlot;
import net.cheto97.rpgcraftmod.menu.slot.PaymentSlot;
import net.cheto97.rpgcraftmod.menu.slot.UpgradeSlot;
...
public class ToolLevelingTableMenu extends AbstractContainerMenu {
    ...
    public ToolLevelingTableMenu(int id, Inventory playerInv, Container container, BlockPos pos) {
        super(ModMenuTypes.TLT_CONTAINER.get(), id);
