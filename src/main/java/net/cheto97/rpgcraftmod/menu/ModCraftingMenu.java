...
import net.cheto97.rpgcraftmod.client.mixing.accessor.CraftingMenuAccessor;
import net.cheto97.rpgcraftmod.world.inventory.ForwardingCraftingContainer;
...
public class ModCraftingMenu extends CraftingMenu implements ContainerListener {
    ...
    public ModCraftingMenu(int id, Inventory inventory, FriendlyByteBuf friendlyByteBu) {
    ...
    public MenuType<?> getType() {
        return ModMenuTypes.CRAFTING_MENU_TYPE.get();
    }
