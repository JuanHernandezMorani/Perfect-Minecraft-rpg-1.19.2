...
public class HudElementViewVanilla extends HudElement {
    ...
    public void drawElement(Gui gui, PoseStack ms, float zLevel, float partialTicks, int scaledWidth, int scaledHeight) {
        ...
        if(focused != null) {
            ...
            gui.blit(ms,posX - 26, 26 + posY,0,128,(int)(92D *(focusedLife /  focusedMaxLife)),36);
            ...
            int x = (posX - 29 + 44 - this.mc.font.width(focusedName) / 2);
            int y = 25 + posY;
            this.drawStringWithBackground(ms, focusedName, x, y, -1, 0);
    ...
    public static void setData(double lifeData, double lifeMaxData,int levelData, double armorData, String nameData){
        focusedLife = lifeData;
        focusedMaxLife = lifeMaxData;
        focusedArmor = armorData;
        focusedName = "LVL. "+levelData+" - "+nameData;
    }
