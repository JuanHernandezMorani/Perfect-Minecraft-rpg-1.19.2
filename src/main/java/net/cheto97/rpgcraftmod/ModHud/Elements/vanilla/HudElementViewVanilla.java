...
public class HudElementViewVanilla extends HudElement {
    ...
    public void drawElement(Gui gui, PoseStack ms, float zLevel, float partialTicks, int scaledWidth, int scaledHeight) {
        ...
        if(focused != null) {
            ...
            drawCustomBar(ms, posX - 25, 34 + posY, 89, 8,  life /  maxLife * 100D,
                    this.settings.getIntValue(Settings.color_life), offsetColorPercent(this.settings.getIntValue(Settings.color_life), OFFSET_PERCENT));
