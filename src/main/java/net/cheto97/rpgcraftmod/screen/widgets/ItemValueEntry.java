...
public class ItemValueEntry extends ObjectSelectionList.Entry<ItemValueEntry> {
    ...
    private void renderItemTooltip(PoseStack mStack, ItemStack iStack, int mouseX, int mouseY, long worth) {
        ...
        tooltips.add(Component.translatable("screen.rpgcraftmod.item_value_worth", worth).withStyle(ChatFormatting.DARK_GRAY));
    ...
    public Component getNarration() {
        if (NARRATION == null) {
            NARRATION = Component.translatable("screen." + RpgcraftMod.MOD_ID + ".item_values");
        }
        return NARRATION;
    }
