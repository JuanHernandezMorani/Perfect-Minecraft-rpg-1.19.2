...
public final class AddStatsPointCommand {
    private static final SimpleCommandExceptionType FAILED_EXCEPTION;

    static {
        FAILED_EXCEPTION = new SimpleCommandExceptionType(Component.literal("Nothing changes, player reach stats point cap or amount is out of range."));
    }

    public static void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext c){
        dispatcher.register(Commands.literal("addpoints")
